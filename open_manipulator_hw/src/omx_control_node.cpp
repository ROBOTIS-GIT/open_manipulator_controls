...
#include "open_manipulator_hw/hardware_interface.h"

void timerCallback(open_manipulator_hw::HardwareInterface &hardware_interface,
...
{
  // init
  ros::init(argc, argv, "open_manipulator_hw");
  ros::NodeHandle node_handle("");
  ros::NodeHandle priv_node_handle("~");
  open_manipulator_hw::HardwareInterface hardware_interface(node_handle, priv_node_handle);
